...
import style from "./user-page-header.module.css";
      ...
      <div className={style.header_right}>
        <div className={style.searchbar}>
          <input
            ...
            type="text"
            className={`${search ? style.active : ""}`}
          />
          <button onClick={() => setSearch(!search)} className={style.icon}>
            <svg
        ...
        <button onClick={() => setPopup(true)} className={style.btn}>
